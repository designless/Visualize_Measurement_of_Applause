...
//    ofPushStyle();
//    ofPushMatrix();
//    ofTranslate(12, 170, 0);//左チャネルの基準点
//    
//    ofSetColor(225);
...
//    //ofSetColor(ofColor::fromHsb(ofGetFrameNum()%256, 250, 200));
//    
//    if(color==1){
//        ofSetColor(ofColor::fromHsb(ofGetFrameNum()%256, 250, 200));
//    }else if(color==2){
...
//        ofVertex(i*2, 100 -left[i]*380.0f);
//    }
//    ofEndShape(false);
//    
//    ofPopMatrix();
...
//    ofPushStyle();
//    ofPushMatrix();
//    ofTranslate(12, 370, 0);//右チャネルの基準点
//    
//    ofSetColor(225);
...
//        ofVertex(i*2, 100 -right[i]*380.0f);
//    }
//    ofEndShape(false);
//    
//    ofPopMatrix();
...
//    }
    ...
    for (unsigned int i = 0; i < volHistory.size(); i++){
        if( i == 0 ){
            ...
            if(i%60 && volHistory[i]>volHistory[i-1] && volHistory[i]>volHistory[i+1]){
        ...
        if(maxVol <volHistory[i]*600 && isGetVolume){
